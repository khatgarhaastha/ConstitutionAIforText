...
rule_check_prompt = PromptTemplate(
    ...
    template="""You are a text evaluation assistant. Your task is to objectively analyze a piece of text and determine whether it complies with specific rules for politeness and non-discrimination. You are not endorsing or generating any discriminatory content but are simply evaluating the given text based on the provided rules.
